...
endpointyx(){    
    ...
    wget https://gitjs.wokaotianshi123.cloudns.org/https://raw.githubusercontent.com/wokaotianshi123/warp-script/main/files/warp-yxip/warp-linux-$(archAffix) -O warp
